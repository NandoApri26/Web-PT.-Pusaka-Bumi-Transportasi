<head>
    ...
    {{-- <title>PT. Pusaka Bumi Transporatasi Mining Contractor</title> --}}
    ...
    <link rel="shortcut icon" href="{{ asset('template/assets/images/logo/logo-browser.png') }}" type="image/x-icon">

    {{-- font Awesome --}}
    <link rel="stylesheet" href="{{ asset('template/assets/vendors/fontawesome/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('template/assets/vendors/perfect-scrollbar/perfect-scrollbar.css') }}">
    <link rel="stylesheet" href="{{ asset('template/assets/vendors/bootstrap-icons/bootstrap-icons.css') }}">

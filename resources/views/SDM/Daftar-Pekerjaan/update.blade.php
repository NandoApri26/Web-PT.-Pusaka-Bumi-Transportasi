...
@section('title', 'PT. Pusaka Bumi Transportasi || Edit Daftar Pekerjaan')
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal"
                                        action="{{ url('/master-data/SDM/Daftar-Pekerjaan/' . $daftarpekerjaan->id) }}"
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="nama_pekerjaan"
                                                            value="{{ $daftarpekerjaan->nama_pekerjaan }}">
                                                    </div>
                                                </div>

...
@section('title', 'PT. Pusaka Bumi Transportasi || Edit Update')
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal"
                                        action="{{ url('/master-data/SDM/mutasi/' . $mutasi->id) }}" method="POST"
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="nama_pegawai" value="{{ $mutasi->nama_pegawai }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="no_pegawai" value="{{ $mutasi->no_pegawai }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            placeholder=" Masukkan Tanggal Promosi" id="tanggal_promosi"
                                                            name="tanggal_promosi" value="{{ $mutasi->tanggal_promosi }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            placeholder=" Masukkan Tanggal Mutasi" id="tanggal_mutasi"
                                                            name="tanggal_mutasi" value="{{ $mutasi->tanggal_mutasi }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="alasan_promosi" value="{{ $mutasi->alasan_promosi }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="alasan_mutasi" value="{{ $mutasi->alasan_mutasi }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="jabatan_lama" value="{{ $mutasi->jabatan_lama }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            placeholder=" Masukkan Alasan Mutasi" id="jabatan_baru"
                                                            name="jabatan_baru" value="{{ $mutasi->jabatan_baru }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="site_project" value="{{ $mutasi->site_project }}">
                                                    </div>
                                                </div>

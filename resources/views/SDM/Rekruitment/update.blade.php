...
@section('title', 'PT. Pusaka Bumi Transportasi || Edit Rekruitment ')
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal"
                                        action="{{ url('/master-data/SDM/Rekruitment/' . $rekruitment->id) }}"
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="radio" name="jkelamin" id="LK"
                                                            value="{{ $rekruitment->jenis_kelamin }}">
                                                        <label for="LK">Laki-Laki</label>
                                                        <input type="radio" name="jkelamin" id="PR"
                                                            value="{{ $rekruitment->jenis_kelamin }}" class="ml-3">
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <select class="form-control" id="daftarpekerjaan_id"
                                                            ...
                                                            value="{{ $rekruitment->daftarpekerjaan_id }}">
                                                            <!-- using FOREIGN ID -->
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" id="ijazah"
                                                            name="ijazah"> {{ $rekruitment->ijazah }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" id="disnaker"
                                                            name="disnaker"> {{ $rekruitment->disnaker }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-10 mt-3">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" id="sertifikat"
                                                            name="sertifikat"> {{ $rekruitment->sertifikat }}
                                                    </div>
                                                </div>

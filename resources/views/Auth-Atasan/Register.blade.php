        ...
        <div id="auth">
            ...
            <div class="row h-100">
                <div class="col-lg-5 col-12">
                    <div id="auth-left">
                        <h1 class="auth-title" style="font-size: 35px">Sign Up Atasan</h1>
                        <p class="auth-subtitle mb-5">Input your data to register to our website.</p>

                        <form action="{{ url('/register_store_atasan') }}" method="post">
                            @csrf
                            ...
                            <input type="hidden" name="level" value="atasan">
                            <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Daftar</button>
                        </form>
                        <div class="text-center mt-5 text-lg fs-4">
                            <p class='text-gray-600'>Sudah memiliki akun? <a href="{{ url('/login_atasan') }}"

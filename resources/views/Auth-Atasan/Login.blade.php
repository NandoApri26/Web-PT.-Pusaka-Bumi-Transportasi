        ...
        <div id="auth">
            ...
            <div class="row h-100">
                <div class="col-lg-5 col-12">
                    <div id="auth-left">
                        <h5 class="auth-title text-center" style="font-size: 35px">Log in Atasan.</h5>
                        <form action="{{ url('/login_store_atasan') }}" method="post">
                            @csrf
                        ...
                        <div class="text-center mt-5 text-lg fs-4">
                            <p class="text-gray-600">Belum memiliki akun? <a href="{{ url('/register_atasan') }}"
